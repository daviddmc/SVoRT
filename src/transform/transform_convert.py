...
transform_convert_cuda = load('transform_convert_cuda', [os.path.join(dirname, 'transform_convert_cuda.cpp'), os.path.join(dirname, 'transform_convert_cuda_kernel.cu')], verbose=True)
